...
def register_help_handlers(bot):
    ...
    def handle_help(message):
        ...
        text = (
            ...
            "/send_tickets — массовая рассылка билетов всем пользователям (включая автоматическую повторную попытку для тех, кому не удалось доставить с первого раза)\n"
            ...
            "/export_users — получить excel-файл со списком пользователей и админов\n"
            ...
            "Команда сама попытается доставить билеты повторно тем, кому не удалось отправить с первого раза.\n"
        )
