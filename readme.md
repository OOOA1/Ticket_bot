...
Telegram Ticket Bot — это инструмент для автоматизации рассылки электронных билетов и управления участниками закрытых мероприятий в Telegram. Проект предназначен для организаторов, которым требуется централизованная, контролируемая и защищённая рассылка PDF-билетов и уведомлений.
